...
function EditJobModal({onClose , rowData }: {onClose: () => void, rowData?: any}) {

    console.log('EditJobModal data:', rowData);

    const editJob = useJobApplicationsStore((state) => state.editJob);
    ...
    const { 
        ...
        defaultValues: {
            ...
            dateSubmitted: rowData?.dateSubmitted || ''
        }
    });
...
const onSubmit: SubmitHandler<any> = (data) => {
    ...
    return (
        <>
            <Stack>
                <h1 className="text-2xl text-center font-bold">Edit Job Application</h1>
